...
<%-------------------------------------------------------------------------------------------------------------------------------%>
			<%--확인--%>
			  <div class="text-center">
			    <%-- 회원탈퇴 --%><input type=button class="btn btn-success" value="회원탈퇴" v-on:click="ok()">
   ...
   new Vue({
	   	...
	   	methods:{
	   		ok:function(){
	   			...
	   			axios.get('http://localhost:8080/web/member/join_delete_ok.do',{
	   				params:{
	   					pwd:this.pwd
	   				}
	   				...
	   				if(res==='yes')
	   				{
	   					location.href="../member/join_delete_check.do";
	   				}
	   				else
	   				{
