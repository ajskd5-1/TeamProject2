...
<%-------------------------------------------------------------------------------------------------------------------------------%>
			...
			<br>
			  <div class="text-center">
			    <%-- 회원탈퇴 --%><input type=submit value="회원탈퇴" class="btn btn-primary">
